...
@interface EmployeeMainViewController ()

@end

@implementation EmployeeMainViewController
...
- (void)viewDidLoad {
    ...
    self.employeeNameLabel.text = self.currentVisa.applicantFullName;;
    
    [self.profilePictureImageView loadImageFromSFAttachment:self.currentVisa.personalPhotoId
