...
#define QUERY_LIMIT_KEY  @"ot_kUITableViewQueryLimit"
#define QUERY_OFFSET_KEY  @"ot_kUITableViewQueryOffser"
...
{
    NSNumber *limitNumber = objc_getAssociatedObject(self, QUERY_LIMIT_KEY);
    return [limitNumber integerValue];
}

- (void)setQueryLimit:(NSInteger)queryLimit
{
    NSNumber *limitNumber = [NSNumber numberWithInteger:queryLimit];
    objc_setAssociatedObject(self, QUERY_LIMIT_KEY, limitNumber, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (NSInteger)queryOffset
{
    NSNumber *offsetNumber = objc_getAssociatedObject(self, QUERY_OFFSET_KEY);
    return [offsetNumber integerValue];
}

- (void)setQueryOffset:(NSInteger)queryOffset
{
    NSNumber *offsetNumber = [NSNumber numberWithInteger:queryOffset];
    objc_setAssociatedObject(self, QUERY_OFFSET_KEY, offsetNumber, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
